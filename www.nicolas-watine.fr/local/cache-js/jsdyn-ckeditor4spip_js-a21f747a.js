/* #PRODUIRE{fond=ckeditor4spip.js}
   md5:7187cc6852d10b59f7ee5cff4b19943b */
...
function SpipEditor2CKEditor(editor_id){
	...
	jQuery('#swapeditor_'+stack[editor_id].md5)
		...
		.find('img')
			.attr('src','http://www.nicolas-watine.fr/plugins/auto/ckeditor/v0.16.18/images/searching.gif');
	...
	jQuery(editor_id).ckeditor(function(){
		...
		jQuery('#swapeditor_'+stack[editor_id].md5)
			...
			.find('img')
				.attr('src','http://www.nicolas-watine.fr/plugins/auto/ckeditor/v0.16.18/images/ckeditor_spip.png') ;
...
function CKEditor2SpipEditor(editor_id){
	...
	jQuery('#swapeditor_'+stack[editor_id].md5)
		...
		.find('img')
			.attr('src','http://www.nicolas-watine.fr/plugins/auto/ckeditor/v0.16.18/images/ckeditor.png')
		.end()
		.attr('disabled',false);
	jQuery(editor_id)
		.attr('disabled',false);
		...
		try {
			...
			if(CKEDITOR.ckeditmode!='ckeditor-exclu'){
				buttons=buttons +
					...
					+'"><img src="http://www.nicolas-watine.fr/plugins/auto/ckeditor/v0.16.18/images/ckeditor.png"/></button>';
			}
